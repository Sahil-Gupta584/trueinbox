                ...
                <section className="hero">
                    ...
                    <div className="hero-left">
                        ...
                        <p className="hero-sub">
                            TrueInbox keeps messages from close friends, real sponsors, and people
                            who matter always within reach — no fan floods, no bots.
                        </p>
                            ...
                            <div className="phone-wrap">
                                ...
                                <div className="chat-body">
                                    ...
                                    <div className="deposit-chip">
                                        ...
                                        <div>
                                            Sponsor placed a <strong>$25 deposit</strong> to message you.
                                            Refunded on reply.
                                        </div>
                                    </div>
                                    <div className="bubble bubble-them">
                                        Hey! We've been following your content for a while and would
                                        love to discuss a paid partnership for our new Vitamin C serum
                                        launch 🌿
                                    </div>
                                    <div className="date-sep bubble-time">9:41 AM</div>
                                    <div className="bubble bubble-them">
                                        Budget is $6,000 for one dedicated post + stories. Let us know
                                        if you're open to it!
                                    </div>
                                    <div className="date-sep bubble-time">9:42 AM</div>
                                    <div className="bubble bubble-me">
                                        Hi! Yes this sounds great — would love to chat. Thursday works
                                        perfectly 🙌
                                    </div>
                                    <div
                    ...
                    <div className="steps reveal">
                        <div className="step">
                            ...
                            <div className="step-desc">
                                A small, refundable deposit is required to message any creator. This
                                alone blocks 99% of spam before it starts.
                            </div>
                        </div>
            ...
            <section id="two-sides" style={{ padding: "80px 24px" }}>
                <div className="container">
                    <div className="reveal text-center" style={{ marginBottom: 52 }}>
                        ...
                        <p className="section-sub" style={{ margin: "14px auto 0" }}>
                            Creators finally have a new income source. Fans finally get the reply
                            they deserve.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            <div style={{ padding: "32px 32px 24px" }}>
                                ...
                                >
                                    Your inbox has always been chaos. TrueInbox turns that chaos into
                                    a signal-only channel — every message that reaches you has already
                                    paid for your time.
                                </p>
                            </div>
                            <div
                            ...
                            >
                                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: "var(--muted)" }}>
                                            Anywhere from $1 to $500. You decide what your attention is
                                            worth.
                                        </div>
                                    </div>
                                </div>
                                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: "var(--muted)" }}>
                                            The fee is yours the moment the message is sent. Reading it is
                                            enough.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: "var(--muted)" }}>
                                            100% of every dollar goes directly to you. We take nothing.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            <div style={{ padding: "32px 32px 24px" }}>
                                ...
                                >
                                    Your messages have always been lost in the noise. TrueInbox gives
                                    you a direct line — pay to be seen, or pay for a guaranteed reply.
                                </p>
                            </div>
                            <div
                                style={{
                            ...
                            >
                                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: "var(--muted)" }}>
                                            Your message lands directly in their inbox, not buried under
                                            hundreds of others.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 12, color: "var(--muted)" }}>
                                            If the creator finds your message worth continuing, they can
                                            refund your DM fee.
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="container">
                    ...
                    <div className="inbox-split reveal">
                        <div className="inbox-panel">
                            <div className="inbox-panel-header" style={{ color: "var(--red)" }}>
                                <div className="panel-dot" style={{ background: "var(--red)" }} />
                            ...
                            <div className="inbox-row" style={{ opacity: "0.3" }}>
                                ...
                                <div className="row-info">
                                    ...
                                    <div className="row-preview">follow me back plsssss 🙏🙏🙏</div>
                                </div>
                                <div className="row-tag tag-no">Spam</div>
                            </div>
                ...
                <div className="container">
                    ...
                    <div className="feat-grid reveal">
                        ...
                        <div className="feat-card">
                            ...
                            <div className="feat-desc">
                                Every sponsor is vetted before they can message you. Brand, budget,
                                and intent confirmed upfront.
                            </div>
                        </div>
                        <div className="feat-card">
                            <div className="feat-icon">📊</div>
                            ...
                            <div className="feat-desc">
                                See your deal history, response rates, and lifetime earnings at a
                                glance. Know your worth.
                            </div>
                        </div>
                        <div className="feat-card">
                            <div className="feat-icon">🔗</div>
                ...
                <div className="container text-center">
                    ...
                    <div className="testi-grid reveal">
                        ...
                        <div className="testi-card">
                            <div className="testi-stars">★ ★ ★ ★ ★</div>
                            <div className="testi-text">
                                "Real brands don't flinch at a deposit. My reply rate went from 12%
                                to 89% — every message now means something."
                            </div>
                            <div className="testi-author">
                                ...
                                <div>
                                    ...
                                    <div className="testi-handle">@marcustech · 890K followers</div>
                                </div>
                            </div>
                        </div>
                        <div className="testi-card">
                            <div className="testi-stars">★ ★ ★ ★ ★</div>
                            <div className="testi-text">
                                "I made $1,200 in one month from ignored fake sponsors. The deposit
                                system literally pays you for the noise."
                            </div>
                            <div className="testi-author">
                ...
                <div className="container text-center">
                    ...
                    <div className="pricing-grid reveal">
                        <div className="price-card">
                            ...
                            <button className="price-btn price-btn-ghost">Join as Creator</button>
                        </div>
                        <div className="price-card featured">
                            <div className="featured-badge">Most Popular</div>
                            <div className="price-tier">Sponsor</div>
                            <div className="price-amount">$25</div>
                            <div className="price-period">per outreach · refundable on reply</div>
                            <ul className="price-features">
                            ...
                            <button className="price-btn price-btn-solid">Start Outreach</button>
                        </div>
                        <div className="price-card">
                            ...
                            <button className="price-btn price-btn-ghost">Upgrade to Pro</button>
                        </div>
                    </div>
                </div>
            </section>
